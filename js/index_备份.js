$(document).ready(function () {
            ...
            for(iCount = 0;iCount < iImgCount;iCount++) {
                ...
                (function (iCount){
                    ...
                    oNewImg.onload = function () {
                        ...
                        allImg[iCount] = oImg;
                        if(++iLoaded == iImgCount){onLoadAll();}
    ...
    function setScaleAnimation(element,scale) {
        ...
        $(element).css({"left":disX,"top":disY});
    ...
    var hintImg = document.querySelector('.left-right-icon');
    ...
    function oLisTouchMove(ev) {
        ...
        if(ev.target.nodeName != "IMG"){
            ...
            if($(ev.target).attr("curImgIndex") && !doubleTouch){
